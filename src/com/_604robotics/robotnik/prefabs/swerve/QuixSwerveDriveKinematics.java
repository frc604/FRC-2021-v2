...
public class QuixSwerveDriveKinematics {
  ...
  public QuixSwerveDriveKinematics(QuixSwerveModule... modules) {
    this(
      Arrays.asList(modules).stream().map((QuixSwerveModule module) -> module.getPosition()).toArray(Translation2d[]::new)
    );
  }
  ...
  public QuixSwerveModuleState[] toSwerveModuleStates(
    ...
    QuixSwerveModuleState[] moduleStates = new QuixSwerveModuleState[m_numModules];
    ...
    for (int i = 0; i < m_numModules; i++) {
      ...
      moduleStates[i] = new QuixSwerveModuleState(speed, angle);
    }
   ...
   */
  public QuixSwerveModuleState[] toSwerveModuleStates(ChassisSpeeds chassisSpeeds) {
